  ...
  return (
    <ImageProvider value={{ src, alt, title, subtitle }}>
      <BarTextProvider value={barTextValue}>
        <div
          className="w-[160px] h-[205px] desktop:w-[231px] desktop:h-[257px]  desktop:mr-[24px] mr-[16px] border border-brand-gray-50 rounded-lg p-4 desktop:p-6 mb-[16px] desktop:mb-[32px] cursor-pointer"
          onClick={handleClick}
        >
