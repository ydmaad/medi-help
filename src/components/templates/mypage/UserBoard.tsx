...
const UserBoard: React.FC<UserBoardProps> = ({ className }) => {
  ...
  return (
    <div className={`${className} w-full desktop:w-[301px] flex justify-center desktop:block`}>
      {/* 데스크탑 버전 */}
      ...
      {/* 모바일 버전 */}
      <div className="desktop:hidden w-[335px]">
        <div className="bg-[#e9f5fe] rounded-xl w-full h-[128px] py-6 px-[42px] flex items-center">
