...
export const LoginForm: React.FC<LoginFormProps> = ({
  ...
  return (
    <div className="w-[335px] desktop:w-full max-w-md">
      <h2 className="text-[28px] font-bold text-center mb-[8px]">로그인</h2>
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <AuthButton
            type="submit"
            className=" bg-brand-primary-500 text-white mt-[8px]"
          >
            로그인
          </AuthButton>
        </div>
      ...
      <div className="mt-[14px]">
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm ">
            <span className="p-[10px] text-[16px] bg-white text-gray-500">
              간편 로그인
            </span>
          </div>
        </div>
